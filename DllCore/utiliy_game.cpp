...
{
	typedef float(__cdecl* callFunc)(float minValue, float maxValue);
	auto fnGetRandomRadius = (callFunc)_F_CallRandomRadius;
	return fnGetRandomRadius(minValue, maxValue);
	/*__asm {
